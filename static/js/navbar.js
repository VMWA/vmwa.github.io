(function() {
  ...
  // Close menu and handle link clicks
  nav.querySelectorAll('a').forEach(link => {
      link.addEventListener('click', (event) => {
          // Check if the link has the scroll-to-section class (smooth scrolling)
          if (link.classList.contains('scroll-to-section')) {
              event.preventDefault(); // Prevent default link behavior for smooth scrolling
